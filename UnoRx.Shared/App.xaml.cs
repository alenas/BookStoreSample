...
namespace UnoRx {
    ...
    sealed partial class App : Application {
        ...
        public App() {
            ...
            RxApp.DefaultExceptionHandler = Observer.Create<Exception>(ex => handler.OnNext(ex), ex => handler.OnError(ex), () => handler.OnCompleted());
        }
        ...
        void ConfigureServices(IServiceCollection services) {
            ...
            {
#if !__WASM__
                services.AddSingleton(B2CAuthenticationService.Instance);
#endif
